...
import Section1 from './assets/Components/Segment 1/section1.jsx'
import Section2 from './assets/Components/Segment 2/section2.jsx'
...
const App = () => {
  const users = [
    ...
    {
      img:'https://images.unsplash.com/photo-1773332611612-ffdaa753afb1?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDF8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxfHx8ZW58MHx8fHx8',
      intro:'',
      color:'Red',
      tag:'Custom'
    }
